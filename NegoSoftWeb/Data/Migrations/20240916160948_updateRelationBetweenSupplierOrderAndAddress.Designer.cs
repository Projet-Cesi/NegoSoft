...
namespace NegoSoftWeb.Data.Migrations
{
    ...
    [Migration("20240916160948_updateRelationBetweenSupplierOrderAndAddress")]
    partial class updateRelationBetweenSupplierOrderAndAddress
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NegoSoftShared.Models.Entities.Supplier", b =>
                {
                    b.HasOne("NegoSoftShared.Models.Entities.Address", "DefaultAddress")
                        .WithOne("Supplier")
                        .HasForeignKey("NegoSoftShared.Models.Entities.Supplier", "SupDefaultAddressId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
